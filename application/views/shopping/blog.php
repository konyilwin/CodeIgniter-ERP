...
<section  class="container features">
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-center  wow zoomIn">
            <img src="<?php echo base_url()."assets/"; ?>img/landing/perspective.png" alt="dashboard" class="img-fluid">
        </div>
    ...
    <div class="row features-block">
        ...
        <div class="col-lg-6 text-right wow fadeInRight">
            <img src="<?php echo base_url()."assets/"; ?>img/landing/dashboard.png" alt="dashboard" class="img-fluid float-right">
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <img src="<?php echo base_url()."assets/"; ?>img/landing/avatar3.jpg" class="img-fluid rounded-circle img-small" alt="">
            ...
            <div class="col-sm-4">
                <div class="team-member wow zoomIn">
                    <img src="<?php echo base_url()."assets/"; ?>img/landing/avatar1.jpg" class="img-fluid rounded-circle" alt="">
            ...
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    <img src="<?php echo base_url()."assets/"; ?>img/landing/avatar2.jpg" class="img-fluid rounded-circle img-small" alt="">
    ...
    <div class="container">
        ...
        <div class="row features-block">
            ...
            <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                <img src="<?php echo base_url()."assets/"; ?>img/landing/iphone.jpg" class="img-fluid" alt="dashboard">
            </div>
